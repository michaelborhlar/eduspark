...
class Migration(migrations.Migration):
    ...
    # No dependency on auth migrations — we reference auth.group and
    # auth.permission by string so Django resolves them lazily.
    dependencies = []
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_type', models.CharField(
                    choices=[('mcq','Multiple Choice'),('typed','Typed Answer'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.CharField(max_length=20, choices=[
                    ('test','Test'),('assignment','Weekly Assignment'),
                ...
                ('answer_type', models.CharField(max_length=20, default='mcq', choices=[
                    ('mcq','Multiple Choice'),('typed','Typed Answer'),
                    ('typed_image','Typed + Image Upload'),
                ])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_image', models.ImageField(
                    blank=True, null=True, upload_to='answers/')),
